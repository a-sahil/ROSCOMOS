...
Vercel link: https://roscomos.vercel.app/
```
...
```bash
flow test cadence/tests/ROSCOMOS_test.cdc
```
...
ROSCOMOS uses Forte Workflow for automated contributions and payouts. See [FORTE_WORKFLOW_INTEGRATION.md](./FORTE_WORKFLOW_INTEGRATION.md) for detailed setup instructions.
