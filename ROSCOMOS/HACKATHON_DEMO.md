# ROSCOMOS Hackathon Demo Guide

## Quick Demo Setup (15 minutes)

This guide gets your ROSCOMOS demo running on Flow testnet with **automated scheduler** for the hackathon.
...
# Expected output:
# ✅ ROSCOMOS deployed to: 0x...
# ✅ ROSCOMOSTransactionHandler deployed to: 0x...
```
...
flow events get A.YOUR_ADDRESS.ROSCOMOS.ContributionPulled \
  --network testnet \
  --start latest
```
...
> "Today I'm demoing ROSCOMOS - an automated ROSCA (Rotating Savings and Credit Association) on Flow blockchain.
>
...
- **Live Contract**: `https://testnet.flowscan.org/contract/A.YOUR_ADDRESS.ROSCOMOS`
