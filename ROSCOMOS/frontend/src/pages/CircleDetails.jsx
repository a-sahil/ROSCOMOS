      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        >
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              <p style={{ color: 'var(--text-secondary)', fontSize: '13px' }}>Circle ID</p>
              <p style={{ color: 'var(--text-primary)', fontWeight: 700 }}>{circle.id}</p>
            </div>
            <div>
              <p style={{ color: 'var(--text-secondary)', fontSize: '13px' }}>Status</p>
              <p style={{ color: 'var(--gold-light)', fontWeight: 700 }}>{getStatusLabel(circle.status)}</p>
            </div>
            <div>
              <p style={{ color: 'var(--text-secondary)', fontSize: '13px' }}>Pool</p>
              <p style={{ color: 'var(--teal-light)', fontWeight: 700 }}>{totalPool.toFixed(2)} FLOW</p>
            </div>
          </div>
        </motion.div>
        {/* Header */}
