  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        >
          <p style={{ color: 'var(--text-secondary)', fontSize: '13px', marginBottom: 4 }}>Design Mode</p>
          <p style={{ color: 'var(--gold-light)', fontWeight: 700 }}>Configure your circle terms, then submit on-chain.</p>
        </motion.div>
        {/* Header */}
