    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        <motion.div
          ...
          style={{ background: 'rgba(17,24,32,0.65)' }}
        >
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              <p style={{ color: 'var(--text-secondary)', fontSize: '13px' }}>Network</p>
              <p style={{ color: 'var(--teal-light)', fontWeight: 700 }}>Flow Testnet</p>
            </div>
            <div>
              <p style={{ color: 'var(--text-secondary)', fontSize: '13px' }}>Wallet</p>
              <p style={{ color: 'var(--text-primary)', fontWeight: 700 }}>{addr ? `${addr.slice(0, 6)}...${addr.slice(-4)}` : 'Not connected'}</p>
            </div>
            <div>
              <p style={{ color: 'var(--text-secondary)', fontSize: '13px' }}>Circles</p>
              <p style={{ color: 'var(--gold-light)', fontWeight: 700 }}>{circles.length}</p>
            </div>
