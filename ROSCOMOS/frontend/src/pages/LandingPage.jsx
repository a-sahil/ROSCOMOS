    ...
    <div className="relative min-h-screen overflow-hidden">
      <section
        style={{
          ...
          background: 'radial-gradient(ellipse 70% 40% at 50% -10%, rgba(212,163,45,0.12), transparent)',
        }}
      >
        <motion.div
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
          style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(212,163,45,0.1)', border: '1px solid rgba(212,163,45,0.3)', borderRadius: '99px', padding: '6px 16px', marginBottom: '24px' }}
        >
          <span style={{ fontSize: '12px', color: '#d4a32d', fontFamily: 'Syne, sans-serif' }}>Built on Flow Blockchain</span>
        </motion.div>
        <motion.h1
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1 }}
          style={{ fontWeight: 800, fontSize: 'clamp(42px, 7vw, 72px)', letterSpacing: '-0.03em', lineHeight: 1.05, marginBottom: '16px', maxWidth: '860px' }}
        >
          Savings Circles, <span className="text-gold">Reimagined</span> for Web3
        </motion.h1>
      </section>
      {/* Animated Background */}
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Why <span className="text-gradient">ROSCOMOS</span>?
          </h2>
